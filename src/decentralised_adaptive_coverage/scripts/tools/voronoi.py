...
class VoronoiCalculator:
    def __init__(self, positions, boundary_type='square', field_size=50):
    ...
    def compute_voronoi(self):
        ...
        field_boundary = Polygon([(-self.field_size/2, -self.field_size/2), (-self.field_size/2, self.field_size/2), 
                                  (self.field_size/2, self.field_size/2), (self.field_size/2, -self.field_size/2)])
        ...
        for region in regions:
            ...
            if poly.is_empty:
                continue
            self.voronoi_regions.append(poly)
